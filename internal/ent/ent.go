...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			learningstreak.Table:       learningstreak.ValidColumn,
			pronunciationattempt.Table: pronunciationattempt.ValidColumn,
			question.Table:             question.ValidColumn,
			questionattempt.Table:      questionattempt.ValidColumn,
			questionreview.Table:       questionreview.ValidColumn,
